...
<center><img src="download.jpeg" width="600" height="100"><br>
...
<div class="w3-container">
  <div class="w3-bar w3-black">
    ...
    <button class="w3-bar-item w3-button tablink" onclick="openCity(event,'Paris')">Insert Student Result</button>
    <button class="w3-bar-item w3-button tablink" onclick="openCity(event,'Paris1')">Update Student Result</button>
    <button class="w3-bar-item w3-button tablink" onclick="openCity(event,'Paris2')">Delete Student Result</button>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="updateStudentResult.jsp" method="">
                                <div class="form-group row">
                                    <label for="full_name" class="col-md-4 col-form-label text-md-right">Roll Number</label>
                                    <div class="col-md-6">
                                        <input type="text"class="form-control" name="rollNo">
...
<main class="my-form">
    <div class="cotainer">
        <div class="row justify-content-center">
            <div class="col-md-8">
                    <div class="card">
                        <div class="card-header">Delete Student Result</div>
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="deleteStudentResult.jsp" method="">
                                <div class="form-group row">
                                    <label for="full_name" class="col-md-4 col-form-label text-md-right">Roll Number</label>
                                    <div class="col-md-6">
                                        <input type="text"class="form-control" name="rollNo">
...
<section>
  ...
  <center><h5>
Designed & Developed by Polepalli Vishnu Sai</h5></center>
  <hr class="new1">
<center><h5>All Right Reserved @ Polepalli Vishnu Sai</h5></center> 
  <hr class="new1">
<br>
</body>
</html>
